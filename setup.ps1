# =============================================================================
# paint-me-like-your-french-substances skill — Setup Script (Windows)
# =============================================================================
# Run this once on any new machine to install all dependencies.
#
# Usage (from PowerShell):
#   cd ~\.claude\skills\paint-me-like-your-french-substances
#   .\setup.ps1
#
# What this does:
...
#
# Note: this installs the ingest/consultant pipeline only. The optional live
# Substance Painter MCP connection (see SETUP.md → "Substance Painter MCP
# Connection") is a separate, manual setup — not part of this script.
# =============================================================================
...
Write-Host "  paint-me-like-your-french-substances skill - Setup" -ForegroundColor Magenta
Write-Host "======================================================" -ForegroundColor Magenta
...
if ($allOK) {
    ...
    Write-Host "  (Optional) For a live Substance Painter connection, see" -ForegroundColor Green
    Write-Host "  SETUP.md -> 'Substance Painter MCP Connection' — separate," -ForegroundColor Green
    Write-Host "  manual, requires Substance Painter installed." -ForegroundColor Green
    Write-Host "======================================================" -ForegroundColor Green
} else {
