...
them. **This library already holds 30 entries whose own Structured Notes discuss
...
|---|---|---|
| Unreal — Sequencer, Niagara, Lumen/Nanite, Movie Render Queue | `unreal-sidekick` | 20 |
| Blender — geometry nodes, Cycles/EEVEE, motion design | `blender-motion` | 10 |
