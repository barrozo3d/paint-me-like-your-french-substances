...
- [How to Paint Realistic Skin in Substance Painter](how-to-paint-realistic-skin-in-substance-painter.md) — same creator; a fully hand-painted-first companion approach (one Fill layer per named skin tone) to this video's reusable-Smart-Mask character-region library, both organized around the same channel-separated, easily-re-gradable philosophy.
