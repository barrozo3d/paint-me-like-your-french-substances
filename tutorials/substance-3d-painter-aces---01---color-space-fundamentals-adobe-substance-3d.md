...
## Related Tutorials
- **Substance 3D Painter & ACES - 02 - OCIO & ACEScg in Painter** (`tutorials/substance-3d-painter-aces---02---ocio-acescg-in-painter.md`) — Part 2/3 of this same series, where the OCIO/ACEScg settings actually get applied inside Substance Painter.
...
- [How to Fix the Substance Painter Viewport to Match Unreal's](how-to-fix-the-substance-painter-viewport-to-match-unreals.md) — different creator/approach (William Faucher, third-party ACES LUT hack via Display Settings rather than Painter's native OCIO/ACEScg Color Management), but addresses the exact same linear-vs-ACES viewport mismatch problem this series covers from the official/theory side.
- [How to Make the Substance Painter Viewport Match Unreal Engine](how-to-make-the-substance-painter-viewport-match-unreal-engine.md) — same third-party-LUT approach as the Faucher video above (different creator, Quinn Kuslich), same underlying color-space mismatch problem.
