...
- [How to make HAND PAINTED SKIN Textures in SUBSTANCE PAINTER](how-to-make-hand-painted-skin-textures-in-substance-painter.md) — Jared Chavez (priority creator); presents a very similar sub-dermal/epidermal two-tier skin color model in full hands-on execution, a practical companion to this talk's theoretical three-layer (sub-dermal/dermis/makeup) framing.
