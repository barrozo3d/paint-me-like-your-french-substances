...
- **"New Path Tool Features & Improvements in Substance 3D Painter"** (`tutorials/new-path-tool-features-improvements-in-substance-3d-painter-adobe-substance-3d.md`, video `exE0-1ftNeE`) — deep-dive on the same 11.0.0 Filled Path tool used here for the rim-ornament height stroke.
