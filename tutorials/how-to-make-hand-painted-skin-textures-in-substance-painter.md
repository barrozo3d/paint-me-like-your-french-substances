---
title: How to make HAND PAINTED SKIN Textures in SUBSTANCE PAINTER
source: YouTube
...
**Source:** [YouTube](https://www.youtube.com/watch?v=GcI60mKZU0k)
**Author:** Jared Chavez
**Duration:** 10m27s | 9 section(s)
...
[0:00] Hey, I'm Jared, and in this video I'm going to show you guys how to texture skin inside Substance Painter by hand.
[0:07] In my last video, I went ahead and showed you guys how I approach creating skin inside ZBrush using Texture XYZ.
[0:13] So in this video, I wanted to go ahead and expand on my process a little bit and show you guys how I would approach the next steps in the pipeline, which is texturing the skin.


### Workflows [0:22]
**Transcript (timestamped):**
[0:23] So to accomplish texturing skin, there's a number of workflows that you can use to achieve a good final result.
[0:29] Differing from the last video, I actually don't use scan data for this part of the process.
[0:34] When texturing, I like to do everything by hand as I tend to find it's a little bit more enjoyable.
[0:40] Also, one benefit to doing it this way is that I don't have to rely on anything to get a final result.
[0:47] If a situation comes up where I need to make skin, I know how to do it without having to use something as a crutch to get myself started.


### Gathering Reference [0:54]
**Transcript (timestamped):**
[0:54] When approaching skin, the first thing that I always like to do is gather reference.
[0:59] Gathering reference is key to making anything feel super believable in CG, but it's especially vital when it comes to creating skin by hand.
[1:07] Some of the resources I use are Pinterest, as you can find tons of great images of a wide variety of people to look at, and the other is actually just using the image carousel on Texture XYZ site.
[1:20] The images that they have in their cross polarized photoset are a great resource to just examine and find some of the nuance that skin has.


### Substance [1:29]
**Transcript (timestamped):**
[1:29] So let's take a look at substance and get started.
[1:31] So the first thing that you'll notice is that I already went through the process of baking and got all of that out of the way.
[1:37] If you're interested in seeing how I set that up, let me know and I can make a video covering it in the future.
[1:42] Okay, so when I approach skin, the thought process that I had is that I want to break the skin down into different layers.
[1:49] Skin has a huge amount of complexity going on with it with all of the layers of blood and bone, and there's just a lot of different things underneath the skin.
[1:58] So to get things started, the first thing I want to do is I want to establish the base layer.
[2:03] This layer is going to be what is called all of the sub dermal colors.
[2:07] We're going to first start by laying down our base red and apply break up on top of this layer.
[2:13] This red, I tend to make a little bit darker.
[2:16] And then next I like to duplicate this layer and make a little bit more of a saturated bright red.
[2:22] I focus this color to more of the AO parts of the model.
[2:26] So to do this, what I do is I throw a mask on top inside of a fill and I put my AO map into it.
[2:33] The next layer is going to be our yellow color.
[2:35] This layer is meant to be some of the bony parts of the skull underneath the skin.
[2:40] I do kind of tend to scatter this color over the whole of the model just to add a little bit of variation underneath the surface of the skin.
[2:49] More variation is better when it comes to these layers in my opinion.
[2:53] Once I have good coverage, the next layer that I'm going to start laying down is going to be my blues.
[2:57] This color I mostly tend to localize to the beard areas or spots where hair grows as well as the bags of the eyes.
[3:05] The last color I use is purple.
[3:08] I use this pretty sparingly in the sub dermal area.
[3:11] The main area that I like to apply this is around the eyes and just a little bit around the lips as well.
[3:16] So once I've gone and laid down all of those colors, next I'm going to move on to the epidermal layer,


### Skin [3:17]
**Transcript (timestamped):**
[3:21] which this layer is going to be all of the values of the actual skin.
[3:26] So the first layer I'm going to lay down is going to be my base skin color.
[3:30] This layer will tend to go through a ton of small color adjustments during the process of making the actual skin.
[3:37] So just know that.
[3:38] I try to find a color that isn't too red as to make the skin feel sick or it isn't too yellow so that the character kind of feels like it has jaundice.
[3:48] When laying down this base layer, one thing I like to do is use the dirt brush.
[3:52] One thing I do when using this brush is turn down the initial brush flow so that the opacity isn't quite as heavy.
[4:00] The reason for this is I still want some of the breakup from underneath the skin to come through.
[4:05] So after getting a full level of coverage of my base color, I start to move on to some more breakup and variation on top of the skin.
[4:13] These layers are mostly going to consist of reds, browns, blues and yellows.
[4:17] They will all have subtle color variation that's going to just start to make the skin feel a little bit more complex and alive.


### Face [4:23]
**Transcript (timestamped):**
[4:24] The face is mostly broken up into three different color zones.
[4:27] The first being the red zone.
[4:29] A lot of this area is mostly focused around the middle third of the face, around the nose and the cheeks.
[4:35] So I like to create a little bit of a darker red and layer some of this color into that area.
[4:41] The next third that I'm going to lay down is going to be the forehead area or any of the areas where some of the bony parts of the face start to show through.
[4:48] For these areas, I use a yellow tone.
[4:51] When approaching skin, I don't necessarily follow a step by step on all of the different colors that I lay down.
[4:57] I mostly just try to diagnose on a moment to moment basis.
[5:00] So you'll notice I add a couple of different layers or dark reds and purples or other variations throughout the entirety of the process.
[5:07] They don't necessarily follow a sequential order.
[5:11] At this stage, I also start to layer in some more variation on top of this that's going to consist of browns and orange spots on the surface.
[5:18] This is going to act as some of the sunspots or damage on top of the skin.


### Sun Spots [5:23]
**Transcript (timestamped):**
[5:23] To do this, I use the Dirt 3 brush and just adjust the flow as well as some of the spacing, just so I get a little bit more of a broad coverage on the surface.
[5:33] Once I have something that I'm happy with, I'll adjust the opacity of the layer so they aren't quite as prominent and it's a little bit more of a subtle nuance to the surface.
[5:41] Here, I also add a peach value just to give another layer of color break up to the surface.
[5:48] Next thing I'll do around this point is adding in my curvature.
[5:52] To do this, I choose kind of a darker red color and mask it out by using my curvature inside of a fill layer.
[5:58] On top of that, I use levels and clamp it down so that the reds focus a little bit more towards the cavities and the pores on the face.


### Blue Spots [6:05]
**Transcript (timestamped):**
[6:05] Now, the last primary color that we're going to want to hit is going to be the blues.
[6:09] The blues are going to be focused on the bottom third of the face.
[6:13] Most of the areas where hair or any of those follicles exist, also around areas such as the eyes.
[6:20] Now that I've laid down a majority of my colors, some of the skin will kind of feel a little bit blotchy.
[6:26] So to fix that, I like to just color pick a general color on the skin and cover the entirety of the skin just with a nice little layer of coverage on top of it.


### Details [6:35]
**Transcript (timestamped):**
[6:36] Now at this point, I would call this section of the skin done.
[6:40] Overall, it's about 80% of the way there.
[6:43] So next, we're going to head into doing some more of the fine detail that we're going to layer on top of all this to kind of just bring it together.
[6:50] When doing the detail layer, I mostly follow the same sort of thought process as the epidermal layer by using different types of dirt brushes.
[6:58] But I also try to get a little bit more control of my coverage on what I'm laying down at this stage.
[7:03] Here, I add some more browns and purples to kind of simulate some more of the freckling and sunspot that's happening underneath the skin.
[7:10] But I want this to be a little bit closer to the surface.
[7:14] After this, I like to start adding in some of the red veins and capillaries underneath the skin around the nose area.
[7:20] The brush that I use for this is the cracks brush.
[7:23] Once I've gotten a good layer of coverage that I'm happy with, I start to play with the opacity.
[7:29] I try to make the veins feel like they're still a little bit deeper underneath the surface and they're not quite on top.
[7:35] To add another layer of wider coverage of veins, I also use procedurals.
[7:40] This allows for a little bit more coverage and adds another level of complexity to the skin.
[7:46] Now with those layers in place, the next few layers aren't going to be quite as focused on details as much as bringing in some more nuanced color to the face.
[7:55] The first is going to be the eye purples.
[7:57] This purpleness is going to be more prevalent around the bags or underneath the eyes.
[8:01] The next color is going to be this bright yellow color.
[8:04] This is also a detail that can be seen in just the corner of the eye area.
[8:08] The next detail that I'm going to do is the veins.
[8:11] I usually lay this down by using the basic soft brush.
[8:14] For this model, I had actually sculpted in this detail where the veins were going to be so that I had a guide ahead of time.
[8:20] I like to do this pass by just initially tracing them out and adding a border on top so that they're not quite as pronounced.
[8:27] To blend them, I use the dirt brush and just soften the edge transitions and adjust the opacity so that it feels like it's underneath the skin as well.
[8:36] Back to the eyes, I like to throw in a bright blue around the under eyes as well as the corners of the mouth.
[8:42] Next, I create some more prominent spots for a little bit more complexity.
[8:47] Here, I also use some oranges and browns, but also throw in a little bit more of a white blotchy color on top of it as well.
[8:53] After doing this, I add in another procedural on top of all this.
[8:57] This is going to be a red, purling noise.
[8:59] This just adds a final layer of complexity that's just going to break up the surface just even a little bit more.
[9:05] The last piece to cap things off that we're going to cover is the lips in the Caramel.
[9:09] The lips are rather straightforward.
[9:11] I tend to choose a base color and layer it over the entirety of the lips, and I follow it up with a few different layers of variation on top of the surface.
[9:21] For this variation, I tend to choose colors that are a little bit more saturated as well as lighter on the value scale,
[9:27] and I just lay them down with a dirt brush to create some subtle variation to the surface.
[9:32] And the last detail that I always want to make sure that I have is going to be the Caramel color.
[9:37] For this, I just use a little bit of a less desaturated red and blend it into the eye waterline.
[9:43] And that's how I like to texture skin my hand.
[9:46] The way that I paint skin really does change each and every time that I do it.
[9:50] I don't always use the exact same colors or necessarily follow the same step-by-step sequence of everything that I lay down,
[9:57] but I do always follow the same logic of layering different colors on top of one another one at a time to build up complexity of the skin.
[10:05] After each layer, I like to evaluate what's next and decide what I can do to help improve the overall quality.
[10:13] So hopefully you found some of this stuff useful.
[10:15] If you have any suggestions for things you'd like to learn in the future or content that you would like me to create,
[10:20] leave it down in the comments below.
[10:22] Make sure you subscribe to see any future videos and thanks again for watching.
[10:25] I'll see you next time.
