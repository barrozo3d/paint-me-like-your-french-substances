...
- [SUBSTANCE PAINTER: SMART MATERIALS Demonstration](substance-painter-smart-materials-demonstration.md) — different creator (Jared Chavez); a usage-focused demonstration of a commercial 12-material Smart Material pack that complements this video's from-scratch creation/save workflow.
...
- **"6 Powerful New Filters in Substance 3D Painter"** (`tutorials/6-powerful-new-filters-in-substance-3d-painter-adobe-substance-3d.md`, video `aCi0RG9-9so`) — the official Adobe feature-tour video this video name-checks directly while demonstrating its Gradient/HSL Perception folder-level filters.
