...
- [Substance Painter - Creating Profesional Textures](substance-painter---creating-profesional-textures.md) — same creator (TriGon); the most advanced of the three-part series (a silent, unnarrated follow-along on the same barrel asset as the "Beginner To Advanced" video), building further on this video's primary/secondary/tertiary breakup and non-destructive filter methodology.
