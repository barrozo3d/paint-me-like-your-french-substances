...
- [Substance Painter Tutorial: Texturing the Coin](substance-painter-tutorial-texturing-the-coin.md) — same creator (Abe Leal 3D); shares the same baking-panel/generator-driven wear philosophy and UI era.
- [Zbrush to Substance Painter Bridge! NEW TOOL!](zbrush-to-substance-painter-bridge-new-tool.md) — same creator; the automated ZBrush-Bridge baking/UDIM pipeline this video covers is a streamlined alternative to the manual Auto-Cage multi-UDIM baking setup used for this door.
- [Optimizing Textures - How to Pack Masks Like a Pro](optimizing-textures---how-to-pack-masks-like-a-pro.md) — same creator; shares the procedural generator/grunge mask-building toolkit, applied there to a from-scratch custom "blood" channel instead of height-carving.
...
- [Baking in Substance 3D painter 8.3](baking-in-substance-3d-painter-83-adobe-substance-3d.md) — same channel (Adobe); this video's Auto-Cage baking (11.0.0+) builds directly on the dedicated Baking Mode foundation that video documents at its 8.3.0 launch (cage overlays, per-Texture-Set settings sync).
- [6 Powerful New Filters in Substance 3D Painter](6-powerful-new-filters-in-substance-3d-painter-adobe-substance-3d.md) — the official Adobe feature-tour video for Bevel Smooth (part of this door's Blur → Bevel Smooth → Blur Slope filter chain) and the primary source confirming its 11.0.0 origin.
