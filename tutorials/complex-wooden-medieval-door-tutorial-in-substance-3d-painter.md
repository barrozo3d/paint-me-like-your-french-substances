...
- Cross-link to `Optimizing Textures - How to Pack Masks Like a Pro` once ingested — same creator, shared procedural/anchor-point/generator vocabulary expected.
