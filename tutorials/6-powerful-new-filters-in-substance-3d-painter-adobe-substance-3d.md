...
- **"Achieve Stunning Stylized Textures in Substance 3D Painter"** (`tutorials/achieve-stunning-stylized-textures-in-substance-3d-painter-adobe-substance-3d.md`, video `WYbp7SY-wEo`) — the dedicated deep-dive this video explicitly defers Stylization-filter coverage to ("we have recorded a dedicated deep-dive tutorial on this specific filter"); same demo still-life scene and same "Art By Anastasia Kukosh" B-roll example confirm the companion pairing.
- **"How to Enable Auto-Updates in Substance 3D Painter"** (`tutorials/how-to-enable-auto-updates-in-substance-3d-painter-adobe-substance-3d.md`, video `13B82VtLuQY`) — same 11.0.0 release; that video customizes this video's Stylization filter in Substance 3D Designer and round-trips it live into Painter using the Auto-Updater.
