---
title: Anchor Point Magic 02 - Micro Normals & Micro Height in Substance 3D Painter | Adobe Substance 3D
source: YouTube
...
**Source:** [YouTube](https://www.youtube.com/watch?v=HL5mZdzzgIg)
**Author:** Adobe Substance 3D
**Duration:** 7m39s | 1 section(s)
...
[0:00] In de tweede video van deze multi-part tutorials series, op hoe te gebruiken anchor points in various ways, we gaan over hoe te creëen dit en resulten.
[0:15] Met de focus op hoe de art dirt en grime, op de teksten over hier, en ook op de normen map-details over hier.
[0:23] We gaan dit met iets wat we als micro-height en micro-normal doen.
[0:29] Zoals je kunt zien, onze normen-map-details over hier, ze zijn niet echt ongeveer ongeveer ongeveer, we schijven ze in de onderkant van de onderkant, dus ze zijn niet in de middel.
[0:37] Maar dankzij de helptijd van anchor points, zijn we nog steeds opgekeerd om de art dirt en grime te hebben.
[0:43] Dus, wat zijn anchor points?
[0:46] Anker points zijn een prachtige feature dat laat je een deel van je layer-stek reëen.
[0:51] Dit betekent dat je een mask of layer kunt bevinden en het dynamisch in andere layers reëen.
[0:59] Als je de anchor point veranderen, zijn alle references ook opgekeerd, zodat je je smarter en sneller werkt.
[1:06] Nu, voordat we begonnen zijn, wilde ik de project op je laten zien dat we opgezet hebben.
[1:11] Dus, eerst hebben we een simpel bronstmateriaal over hier, zoals vorige keer.
[1:17] Dan op de top van dit hebben we een fill layer die alleen als de hoge map geïactiviseerd is.
[1:22] En dit fill layer heeft een mask met een tekst. Ik spreek over dit tekst dat je kunt zien.
[1:28] Nu, op de top van dit hebben we een heel simpel dirt fill layer, dus dit is een simpel fill layer
[1:35] met een base color die alleen geïactiviseerd is, dat is zwart, een raftness die kan controleren
[1:40] zoals de raftnessmateriaal van je dirt en een metallic map die ook zwart is.
[1:46] Nu, dit fill layer heeft een zwarte mask en deze zwarte mask heeft een generator op het.
[1:50] Ik heb je al in de vorige video gegeven hoe te aardigen een generator.
[1:54] We hebben ook deze generators smart masks gekomen, die je over hier kunt vinden
[1:58] als je het wilt veranderen met een verschillende type of smart mask.
[2:01] Dus deze generator heeft een simpel dirt generator die we gewoon aardigen,
[2:05] een beetje extra dirt op ons model.
[2:09] Dus wat we nu gaan doen is dat we de aardigen wat extra dirt willen aardigen om ons tekst over hier.
[2:15] Maar we willen onze smart mask gebruiken om deze dirt te genereren,
[2:19] omdat we niet willen gaan in en doen van de painting.
[2:22] En dit is waar onze aardigen komen.
[2:25] Dus wat we kunnen doen is dat we iets kunnen gebruiken kiezen die een micro-heid is.
[2:29] De manier waarin dit werkt is dat we naar onze tekstlayer gaan en je gewoon naar
[2:33] je simpel mask gaat en je wilt een aardigen op een aardigenpunt hier.
[2:37] Soms, beantwoordelijk, beantwoordelijk dat de tekstlayer onder is en dan de dirt in
[2:42] waar we alles gaan genereren is op de top, want het is ook hoe de aardigen ooit leren.
[2:48] Dus we kunnen even gaan en we kunnen de naam te tekst, mask of je kunt double clicken en je kunt het veranderen.
[2:54] Dus hoe gaan we ons generator vertellen dat deze tekstmask in een heidmap is en om het
[3:00] in onze dirt te inkleden. We kunnen dit door klikken op onze smart mask en
[3:06] alle enkele smart mask hier heeft de exacte samingsetting, dus neem niet voor dat.
[3:12] En dan wat je wilt doen is dat je wilt, als we dit een beetje groter maakten,
[3:15] je wilt even gaan gaan en scrollen helemaal naar beneden.
[3:18] Nu hieronder zie je een micro-normaal en een micro-heid,
[3:23] want dit is een zwarte en witte tekst, omdat het een mask is.
[3:28] Het is een micro-heid, maar later in dit tutorial zal ik je ook laten zien hoe het
[3:32] uit micro normaal is. Dus we gaan naar onze micro-heid, we gaan naar anchor points
[3:38] en we hebben onze tekstmask over hier. Nu is niets gebeurd, dit is omdat we
[3:44] moeten gaan en we moeten scrollen en in onze micro-details over hier moeten we het opzetten.
[3:51] Dus hier kun je zeggen, oké, ik wil voorbeeld een micro-heid activeren. Je pressen
[3:56] het, en nu kun je zien dat het uit de dirt heeft naar onze micro-heid. We kunnen onze
[4:02] curvature intensiteit zetten, we kunnen onze hoge details zetten en we kunnen ook
[4:05] spelen uit met de AO radius en dingen zoals dat. Maar we hebben een probleem. Ik wil
[4:11] eigenlijk deze dirt hebben zitten zoals in de opzettende richting, ik wil het in
[4:14] tussen mijn tekst hebben en niet op de top van mijn tekst. Dit is heel simpel, we willen
[4:19] gewoon scrollen naar onze micro-heid, gaan naar onze levels en verwerken. En dat is het.
[4:26] Nu kun je het terug opzetten en je kunt gewoon met deze settings een beetje
[4:31] opzetten om je dirt te aardigen wat je hier over kunt zien. Dus ik zou je gewoon
[4:35] speelen met het, meestal de AO radius is de een die je meestal zal geven,
[4:40] omdat de AO in dit geval heel sterk over hier.
[4:45] Nu wat ik wil laten zien is, ik wil ook laten zien hoe je de micro-heid
[4:48] opzetten. Nu voor de normale details, ik ga je gewoon een heel basic
[4:54] egentie laten zien, om je te laten zien hoe alles werkt. Dus als we hier naar
[4:58] gaan en hier bovenin een tekst, wat we willen doen is dat we een simpel
[5:03] laag willen doen. En laten we daarna gewoon double klik op en kiezen dit laag
[5:08] normaal, onder de details. Nu in deze laag wil je gewoon naar
[5:13] naar naar, je wilt gewoon scrollen naar hier naar je maps en je wilt
[5:17] turneren alles van, terwijl voor de nrm, die is je normale slot.
[5:23] Nu, alles wat we nu moeten doen is dat we hier naar de tekst gaan
[5:26] in tekst en dan willen we naar naar en grap een
[5:29] interessant normaal. Ik ging daar en ik ging voor de event capsules horizontal.
[5:36] Natuurlijk kan je wat je wilt voor dit gebruiken. We willen naar naar en dragen
[5:40] dit naar onze normale slot hierover en nu met een brush, als je hier klikt,
[5:45] kun je zien dat het nu in onze normale schijf is, maar de
[5:49] schijf is eigenlijk veranderd met wat van de normaal. Je kunt het van dit
[5:53] gewoon op de afstand gaan en gewoon de x-button opgepakt
[5:57] om je afstand helemaal scherp te maken. En daar gaan we, nu hebben we een normaal.
[6:02] Dus ik ga dit superbasisch doen. Ik ga niet deze
[6:06] mooi adal maken, ik ga het gewoon klik een paar keer tot ik
[6:10] het effect van het wantst van het schijf wil, want het is gewoon voor
[6:15] showcase. Ik zou natuurlijk veel meer tijd over hebben in dit, als je het wil
[6:18] het heel mooi maken. Dus laten we naar beneden en laten we iets zoals dat
[6:22] bijvoorbeeld. Het is gewoon dat het uit een disteemt vormt, het ziet echt cool.
[6:27] Dus hierover hebben we nu onze normaal map details.
[6:30] Nu, alles wat we nu moeten doen is dat we een art en enkel point moeten doen.
[6:34] We moeten niet een mask maken, want dit keer bevindt we een normaal,
[6:38] die niet de zwarte en zwarte map is. Dus we willen gewoon naar onze magische
[6:42] kwant en art en enkel point en ik ga gewoon de naam uitleggen.
[6:47] Nu, dit gaat super simpel zijn, want we hebben al de meeste
[6:51] opzijde voor onze micro height. Dus alles wat we moeten doen is dat we
[6:55] moeten alles op de weg gaan en dan in onze micro normaal willen we
[6:58] naar de enkel points en we willen de normaal details grapje gaan.
[7:03] Heel belangrijk, maak er voor om de referentie channel te zetten
[7:07] naar normaal, want anders is het niet referentie de correcte channel.
[7:11] En we willen referentie onze normaal channel.
[7:15] Zodra dit is gedaan, kunnen we gewoon opkomen en dan over hier in onze micro details
[7:20] kunnen we onze normaal micro turneren en instanelijk kun je zien dat het
[7:24] gebruikt van dezelfde settings en nu hebben we ook onze deur op een
[7:27] normaal micro en dat is eigenlijk hoe de micro height en de
[7:31] normaal micro werkt met enkel points in de Substance 3D painter.
