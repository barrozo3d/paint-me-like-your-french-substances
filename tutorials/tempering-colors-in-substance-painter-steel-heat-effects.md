...
- [Realistic Wood in Substance Painter | M24 Grenade Texturing](realistic-wood-in-substance-painter-m24-grenade-texturing.md) — same creator, same project series, Part 1 (wood handle) preceding this video's metal parts. Establishes the anchor-point-as-shared-foundation architecture this video's own anchor-driven paintable mask builds on.
- [Powerful Substance Painter Tricks That You Need To Know](powerful-substance-painter-tricks-that-you-need-to-know.md) — same creator; explicitly reuses this video's Tempering Colors smart material for a weld-seam rainbow heat-tint effect, swapping in a custom Anchor-Point-fed mask built from a blurred/expanded weld-seam mask in place of the default paintable anchor mask.
