...
- [Substance Painter Beginner Tutorial for Unreal Engine 5](substance-painter-beginner-tutorial-for-unreal-engine-5.md) — different creator (Unreal Sensei); covers the same Dirt-via-AO / Metal-Edge-Wear-via-Curvature generator masking and layered-blend-mode-effects philosophy at foundational depth, plus an Anchor-Point-fed Micro-Height generator use case for hand-sculpted detail.
...
- [HOW TO MASTER TEXTURing in SUBSTANCE PAINTER](how-to-master-texturing-in-substance-painter.md) — same creator; conceptual companion piece — the primary/secondary/tertiary phase philosophy stated there is the reasoning behind why this video builds masks in generator-first, manual-breakup-second order.
- [HOW to Make a Peeled Paint Effect with ANCHOR Points | SUBSTANCE PAINTER](how-to-make-a-peeled-paint-effect-with-anchor-points-substance-painter.md) — same creator, direct sequel; applies this video's anchor-point fundamentals to a full production peeling-paint effect (double-anchor-reference with Subtract blend mode to isolate a grown edge ring).
- [SUBSTANCE PAINTER: SMART MATERIALS Demonstration](substance-painter-smart-materials-demonstration.md) — same creator; a product tour of a commercial Smart Material pack built entirely on this video's anchor-point-as-mask-source fundamentals — every material's secondary effects (color variation, lifted edges, cracks) reference one base paint layer via anchor points.
