...
- **"Footwear Texturing from Start to Finish – Live Tutorial in Substance 3D Painter"** (`tutorials/footwear-texturing-from-start-to-finish-live-tutorial-in-substance-3d-painter-ad.md`, video `s59xbaF4Q14`) — same Adobe-official project-breakdown format and Emissive-channel neon/glow technique (Texture Set Settings → Channels → Emissive), applied there to footwear accents instead of architectural signage.
