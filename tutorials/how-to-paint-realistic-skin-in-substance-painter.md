...
- [How to MAKE HAND PAINTED TEXTURES and SUBSTANCE PAINTER | Dragonite](how-to-make-hand-painted-textures-and-substance-painter-dragonite.md) (Jared Chavez) — different creator; a deliberately stylized/illustrative hand-painting approach (graphic, non-photoreal blood/damage shapes) that contrasts usefully with this video's fully hand-painted-first color map aimed at photoreal skin.
- [How to make HAND PAINTED SKIN Textures in SUBSTANCE PAINTER](how-to-make-hand-painted-skin-textures-in-substance-painter.md) (Jared Chavez) — different creator; another fully hand-painted-first (no photo projection) realistic skin color map — strong side-by-side comparison of two independent artists' approaches to the same no-scan, hand-painted skin problem.
- [How to TEXTURE in SUBSTANCE PAINTER | ORC TEXTURES](how-to-texture-in-substance-painter-orc-textures.md) (Jared Chavez) — different creator; complementary full-character skin approach using three discrete frequency-band discoloration layers plus hand-painted flaking-skin Height detail, versus this video's fully hand-painted-first color-map methodology.
