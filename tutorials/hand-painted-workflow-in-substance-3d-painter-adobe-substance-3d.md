...
- **"Baking in Substance 3D painter 8.3"** (`tutorials/baking-in-substance-3d-painter-83-adobe-substance-3d.md`, Adobe) — this video's AutoCage-assisted baking (11.0.0+) is a later evolution of the dedicated Baking Mode that video documents at its 8.3.0 launch.
