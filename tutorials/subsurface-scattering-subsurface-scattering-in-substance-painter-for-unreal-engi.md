...
- [HOW to Make UDIMS for UNREAL ENGINE](how-to-make-udims-for-unreal-engine.md) — same creator, same Neomorph character; an earlier pipeline stage on the identical asset (the UDIM UV/baking setup that made this video's Scattering channel work possible).
