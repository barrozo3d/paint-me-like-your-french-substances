...
- [SUBSTANCE PAINTER: SMART MATERIALS Demonstration](substance-painter-smart-materials-demonstration.md) — same creator; that video's "Paint Peeled" Smart Material is the packaged, pre-built product version of the exact from-scratch technique built here — read together to see both the finished tool and its construction.
