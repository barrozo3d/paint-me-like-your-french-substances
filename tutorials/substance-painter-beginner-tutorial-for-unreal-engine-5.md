...
- [SUBSURFACE SCATTERING: Subsurface Scattering in SUBSTANCE PAINTER for UNREAL ENGINE 5](subsurface-scattering-subsurface-scattering-in-substance-painter-for-unreal-engi.md) — different creator (Jared Chavez); a focused Painter-to-UE5 round-trip example (custom Scattering channel to a SubsurfaceProfile asset) that complements this video's broader multi-texture-set/Nanite export coverage.
